...
export type GetSearchResultsByQueryQuery = { __typename?: 'Query', publicationsByQuery: Array<{ __typename?: 'PublicationResponseDto', id: string, title: string, source: Types.PublicationSource, doi?: string | null, url?: string | null, authors?: Array<string> | null, publicationDate?: any | null }> };
