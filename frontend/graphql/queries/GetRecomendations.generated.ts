...
export type GetRecommendationsQuery = { __typename?: 'Query', recommendations: Array<{ __typename?: 'RecommendationResponseDto', publications: Array<{ __typename?: 'PublicationResponseDto', id: string, title: string, authors?: Array<string> | null, publicationDate?: any | null, doi: Array<string>, url?: string | null }> }> };
