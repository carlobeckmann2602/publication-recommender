...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'LoggedIn', jwt: { __typename?: 'JwtDto', accessToken: string, refreshToken: string, expiresIn: number }, user: { __typename?: 'User', id: string, email: string, name: string } } };
