...
import { MessageQueControler } from './messageQue/controllers/messageQue.controller';
import { MessageQueService } from './messageQue/services/messageQue.service';
...
@Module({
  imports: [
    ...
    ClientsModule.register([
      {
        name: 'MESSAGEQUE_SERVICE',
        transport: Transport.RMQ,
        options: {
          urls: ['amqp://rabbitmq'],
          queue: 'annoy_data_send',
          queueOptions: {
            durable: false,
          },
        },
  ...
  controllers: [MessageQueControler],
})
